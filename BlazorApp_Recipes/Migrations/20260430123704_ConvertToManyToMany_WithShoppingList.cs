...
{
    public partial class ConvertToManyToMany_WithShoppingList : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingListIngredients", x => new { x.IngredientsId, x.ShoppingListsId });
                    table.ForeignKey(
                        name: "FK_ShoppingListIngredients_Ingredient_IngredientsId",
                        column: x => x.IngredientsId,
                        principalTable: "Ingredient",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingListIngredients_ShoppingList_ShoppingListsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingListIngredients_ShoppingListsId",
